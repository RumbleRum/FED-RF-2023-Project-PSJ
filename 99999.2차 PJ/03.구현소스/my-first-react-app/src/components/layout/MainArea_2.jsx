                        ...
                        <div className="flex-box">
                            ...
                            <div className="partbox col-12 video1">
                                <video width="45%" height="auto" autoplay loop muted>
                                    <source src="../../../public/images/videoplayback2.mp4" type="video/mp4" />
                                </video>
                            </div>
                            <div className="partbox col-12 ep2-1">
                                <h1>Resorts World</h1>
                            ...
                            <div className="partbox col-12 ep2-2">
                                <h1>
                                    <br />
                                    <br />
                                    10년 만에 라스베이거스 스트립에 건설된 최초의 통합 리조트인 리조트 월드 라스베가스는 기술과<br />
                                    도시형 현대 리조트의 고풍스러운 매력을 지닌 인테리어와 함께
                                    국제적인 리조트 월드 브랜드의 시설을 느껴보실수 있습니다.</h1>
                            </div>
                        </div>
                    </div>
                </section>
